...
qualifier_map = {
    ...
    "Exact Referee" : {},
    "Exact Umpire" : {},
    "Exact Team Head Coach" : {},
    "Exact Opponent Head Coach" : {},
    "Temperature" : {},
    "Humidity" : {},
    "Wind" : {},
    "Wind Chill" : {},
    ...
    "Team After Bye" : {},
    "Team Before Bye" : {},
    "Team After Playoffs Bye" : {},
    "Team Before Playoffs Bye" : {},
    "Team Game After Bye" : {},
    "Team Game Before Bye" : {},
    "Team Had Bye" : {},
    "Opponent After Bye" : {},
    "Opponent Before Bye" : {},
    "Opponent After Playoffs Bye" : {},
    "Opponent Before Playoffs Bye" : {},
    "Opponent Game After Bye" : {},
    "Opponent Game Before Bye" : {},
    "Opponent Had Bye" : {},
    "Probable" : {},
    "Questionable" : {},
    "Doubtful" : {},
...
def url_request(url, timeout=30, failed_counter=0):
    ...
    while(True):
        ...
        try:
            response = da_session.get(url, timeout=timeout, headers=request_headers, allow_redirects=False)
